...
const defaultSearchIcon = (
  <Icon
    ...
    style={{ marginRight: 10, height: 44 }}
  />
);
  ...
  _renderItems = () => {
    ...
    if (renderItems.length) {
      ...
      if (onNoResultsPressed) {
        itemList = (
        <TouchableOpacity style={{ flexDirection: "row", alignItems: "center", "justifyContent": "center" }} onPress={() => {onNoResultsPressed(); this._clearSearchTerm();}}>
            <Text
              style={[
                {
                  flex: 1,
              ...
              {hideSubmitButton && (
                <TouchableOpacity onPress={this._submitSelection}>
                  <Icon
                    ...
                    style={[
                      styles.indicator,
                      { paddingLeft: 15, paddingRight: 15, height: 44 }
                    ]}
                  />
                </TouchableOpacity>
              )}
