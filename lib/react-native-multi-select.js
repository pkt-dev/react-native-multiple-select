...
export default class MultiSelect extends Component {
    static propTypes = {
        ...
        onNoResultsPressed: PropTypes.func,
        noResultStyle: Text.propTypes.style
    };
    ...
    _getRow = (item, index) => {
        ...
        return (
            <TouchableOpacity
                ...
                accessible={true}
                accessibilityLabel={`multi-select option ${index}`}
                style={[
        ...
        if (renderItems.length) {
            itemList = (
                <FlatList
                    ...
                    renderItem={rowData => this._getRow(rowData.item, rowData.index)}
                    {...flatListProps}
                />
            );
            ...
            if (onNoResultsPressed) {
                itemList = (
                    <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center' }} onPress={() => { onNoResultsPressed(searchTerm); this._clearSearchTerm(); }}>
                        <Text
                            style={[
                                {
                                    marginTop: 10,
